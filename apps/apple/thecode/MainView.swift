...
struct MainView: View {
    ...
    var body: some View {
        NavigationView {
            ...
            // Sur le Form et non sur la NavigationView : deux .alert sur une
            // même vue ne s'affichent pas toujours tous les deux.
            .alert(
            ...
            .onAppear {
                ...
                refreshVaultEntry()
                // Lancement : ce qu'un autre appareil (ou l'extension AutoFill)
                // a écrit entre-temps.
